import { E as HalfFloatType, It as Vector3, Lt as Vector4, Pt as UniformsUtils, St as ShaderMaterial, X as Mesh, Y as Matrix4, _ as Color, lt as Plane, zt as WebGLRenderTarget } from "./@react-three/drei+[...].mjs";
...
//#endregion
//#region node_modules/three/examples/jsm/objects/Reflector.js
/**
...
*/
var Reflector = class Reflector extends Mesh {
	/**
	...
	constructor(geometry, options = {}) {
		...
		*/
		...
		this.onBeforeRender = function(renderer, scene, camera) {
			...
			if (view.dot(normal) > 0 === true && this.forceUpdate === false) return;
...
//#endregion
export { MeshoptDecoder as n, Reflector as t };
